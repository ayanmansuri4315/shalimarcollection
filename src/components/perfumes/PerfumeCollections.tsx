...
export const PerfumeCollections: React.FC<PerfumeCollectionsProps> = ({
  ...
  return (
    <section className="py-20 bg-[#fbf9f5]" id="perfume-collections">
            ...
            >
              ...
              <div className="p-5 flex-1 flex flex-col justify-between space-y-3">
                <div>
                  ...
                  <h3 className="text-xl font-serif font-medium text-[#1f1a17] mt-1">
                    {category.name}
                  </h3>
                  <p className="text-xs text-[#6c625a] mt-1.5 line-clamp-3 leading-relaxed">
                ...
                <div className="pt-2 border-t border-[#f0e6d8] flex items-center justify-between">
                  <button
                    ...
                    id={`view-details-perfume-cat-${category.id}`}
