...
export const PerfumeHero: React.FC<PerfumeHeroProps> = ({
  ...
  return (
    ...
    >
      {/* Background Ambience */}
      <div className="absolute top-10 left-1/2 -translate-x-1/2 w-full max-w-7xl h-96 bg-[#eadbc5]/30 rounded-full blur-3xl pointer-events-none" />
            ...
            <div className="pt-4 border-t border-[#ebd9c7] max-w-lg mx-auto lg:mx-0">
              <div className="p-4 rounded-xl bg-[#f4ebd9]/80 border border-[#ded0bb] flex flex-col sm:flex-row items-center justify-between gap-3 text-left">
                ...
                <button
                  ...
                  className="w-full sm:w-auto px-4 py-2 rounded-xl bg-[#241f1c] text-[#fcfaf7] text-xs font-semibold hover:bg-[#3d342f] transition-colors flex items-center justify-center gap-1.5"
                >
            ...
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              <div className="hidden sm:flex absolute -bottom-6 -left-6 p-4 rounded-xl bg-[#fcfaf7] border border-[#e2d5c3] shadow-lg items-center gap-3 max-w-[240px]">
                ...
                <div>
                  ...
                  <span className="block text-[11px] text-[#73685e]">Wild Assam & Cambodian Agarwood</span>
                </div>
              </div>
