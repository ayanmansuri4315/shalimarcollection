...
import { ArrowRight, Sparkles, MapPin, Layers, ChevronDown, Droplet } from 'lucide-react';
...
export const PerfumeHero: React.FC<PerfumeHeroProps> = ({
  ...
  const scrollToCollections = () => {
    const el = document.getElementById('perfume-collections');
  ...
  return (
    <section 
      className="relative pt-8 pb-16 sm:pt-12 sm:pb-24 overflow-hidden bg-gradient-to-b from-[#fbf9f5] via-[#f5efe3] to-[#fbf9f5]"
      id="perfume-hero"
    >
      ...
      <motion.div 
        ...
        className="absolute top-10 left-1/2 -translate-x-1/2 w-full max-w-7xl h-96 bg-[#eadbc5]/35 rounded-full blur-3xl pointer-events-none" 
      />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <motion.div variants={itemVariants}>
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#f2e7d7] border border-[#e2d3bf] text-[#7a5d20] text-xs font-semibold uppercase tracking-widest shadow-xs">
                <Droplet className="w-3.5 h-3.5 text-[#9b7832]" />
                <span>Haute Parfumerie & Pure Oud</span>
              </div>
            </motion.div>
            ...
            >
              The Essence<br />
              <span className="italic font-light text-[#8a6825]">Of Luxury</span>
            </motion.h1>
            ...
            >
              Discover our exclusive collection of perfumes, attars & ouds crafted for a timeless impression. Distilled from rare agarwoods, Taif roses, and precious amber resins.
            </motion.p>
            ...
            >
              <button
                ...
                id="perfume-hero-explore-collection-btn"
              ...
              <button
                ...
                id="perfume-hero-visit-showroom-btn"
            ...
            {/* Subtle Portal Switch Card in Hero to go to Fabric */}
            <motion.div 
              variants={itemVariants}
              ...
              <div className="p-4 rounded-xl bg-[#f4ebd9]/80 border border-[#ded0bb] flex flex-col sm:flex-row items-center justify-between gap-3 text-left">
                <div>
                  <span className="text-xs uppercase tracking-wider text-[#5c5249] font-semibold block">
                    Explore Our Other Department
                  </span>
                  <span className="text-sm font-serif font-medium text-[#1f1a17]">
                    Bespoke Fabric Atelier
                  </span>
                </div>
                <button
                  onClick={() => onSwitchPortal('fabric')}
                  id="perfume-hero-switch-to-fabric-btn"
                  className="w-full sm:w-auto px-4 py-2 rounded-xl bg-[#241f1c] text-[#fcfaf7] text-xs font-semibold hover:bg-[#3d342f] transition-all duration-200 hover:-translate-y-0.5 active:translate-y-0 active:scale-[0.98] flex items-center justify-center gap-1.5 cursor-pointer"
                >
            ...
            >
              ...
              <div className="relative rounded-2xl overflow-hidden aspect-4/5 shadow-2xl border border-[#e2d5c3] bg-[#eae0d1] group">
                <motion.img
                  ...
                  alt="Luxury Fragrance and Oud Bottles at Shalimar Collection"
                ...
                <div className="absolute bottom-5 left-5 right-5 p-4 rounded-xl bg-[#fcfaf7]/95 backdrop-blur-md border border-[#e4d6c3] flex items-center justify-between shadow-md">
                  <div>
                    ...
                    <span className="text-sm font-serif font-medium text-[#1f1a17]">
                      Shalimar Imperial Oud Royal Extrait
                    </span>
                  </div>
              ...
              >
                ...
                <div>
                  <span className="block text-xs font-semibold text-[#1f1a17]">100% Pure Distillates</span>
                  <span className="block text-xs text-[#73685e]">Wild Assam & Cambodian Agarwood</span>
                </div>
              </motion.div>
        ...
        >
          <button
            onClick={scrollToCollections}
            id="perfume-scroll-to-collections-btn"
