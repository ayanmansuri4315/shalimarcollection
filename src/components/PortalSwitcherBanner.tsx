...
export const PortalSwitcherBanner: React.FC<PortalSwitcherBannerProps> = ({
  ...
  if (currentPortal === 'fabric') {
    return (
      <section className="py-12 bg-[#f4ece1]/70 border-y border-[#ebd8c7] relative overflow-hidden" id="fabric-portal-switch">
          ...
          <div className="bg-[#fcfaf7] border border-[#e2d5c3] rounded-2xl p-6 sm:p-10 shadow-sm">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
              ...
              <div className="max-w-2xl text-center lg:text-left space-y-2">
                <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#ede1cf] border border-[#dcc9b0] text-[#7c5e20] text-xs font-semibold uppercase tracking-wider">
                ...
                <p className="text-sm text-[#6c625a] leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-3 w-full lg:w-auto">
                <button
                  ...
                  className="w-full sm:w-auto flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-xl bg-[#241f1c] hover:bg-[#3d342f] text-white text-xs font-semibold uppercase tracking-wider shadow-sm transition-all group"
                >
                ...
                <button
                  ...
                  className="w-full sm:w-auto flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-xl bg-[#ede2d2] hover:bg-[#e4d4bf] text-[#2c241f] border border-[#d8c5ad] text-xs font-semibold uppercase tracking-wider transition-all group"
                >
                  <Sparkles className="w-4 h-4 text-[#9b7832]" />
                  <span>Discover Perfumes</span>
                  <ArrowRight className="w-4 h-4 text-[#9b7832] group-hover:translate-x-0.5 transition-transform" />
                </button>
              </div>
            </div>
          </div>
  ...
  return (
    <section className="py-12 bg-[#f4ece1]/70 border-y border-[#ebd8c7] relative overflow-hidden" id="perfumes-portal-switch">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="bg-[#fcfaf7] border border-[#e2d5c3] rounded-2xl p-6 sm:p-10 shadow-sm">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            <div className="max-w-2xl text-center lg:text-left space-y-2">
