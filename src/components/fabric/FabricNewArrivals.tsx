...
import { Eye, Sparkles, MessageSquare, Info } from 'lucide-react';
...
export const FabricNewArrivals: React.FC<FabricNewArrivalsProps> = ({
  ...
  return (
    <section className="py-20 bg-[#f7f3eb] border-y border-[#ede3d5]" id="fabric-new-arrivals">
            ...
            >
              ...
              <div className="p-5 flex-1 flex flex-col justify-between space-y-3">
                <div>
                  ...
                  <p className="text-xs text-[#5c5249] mt-1 line-clamp-2 leading-relaxed">
                    {fabric.description}
                  </p>
                </div>
                ...
                <div className="pt-2 border-t border-[#ede3d5] flex items-center justify-between">
                  <button
                    ...
                    className="text-xs font-semibold text-[#1f1a17] group-hover:text-[#8a6825] transition-colors flex items-center gap-1"
                  >
